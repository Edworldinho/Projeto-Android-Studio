...
public class Logar extends AppCompatActivity implements View.OnClickListener {
    ...
    public static DatabaseReference firebaseD;
    ...
    private void login(){
        ...
        auth.signInWithEmailAndPassword(logarMail, logarPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Intent it = new Intent(Logar.this, Area_do_Professor.class);
        ...
        firebaseD = FirebaseDatabase.getInstance().getReference("Professor");
        firebaseDatabase = firebaseD.child("" + (logarName));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.cadastro:
                ...
                startActivity(new Intent(this, Inscrever_se.class));
