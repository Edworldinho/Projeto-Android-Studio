...
public class Inscrever_aluno extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inscrever_aluno);
        ...
        firebaseAuth.createUserWithEmailAndPassword(inscreverMail,inscreverPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Intent intent = new Intent(Inscrever_aluno.this, Area_aluno.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ja_cadastro:
                ...
                startActivity(new Intent(Inscrever_aluno.this, Login_aluno.class));
